...
Census1 <- rbind(tx.acs16,ak.acs16,LA.acs16,NM.acs16,OK.acs16)
Census1 = select(Census1,-1,-3:-15)
view(Census1)

save(Census1,file = "./Build/Output/Census1.RData")
...
Census2 <- rbind(tx.acs19,ak.acs19,LA.acs19,NM.acs19,OK.acs19)
...
view(census3)
save(census3,file = "./Build/Output/Census3.RData")
...
core<-merge(tx.acs16,texasacs16,by.x="state",by.y="state")
